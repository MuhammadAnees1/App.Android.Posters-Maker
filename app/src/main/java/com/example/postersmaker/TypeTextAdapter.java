...
public class TypeTextAdapter extends RecyclerView.Adapter<TypeTextAdapter.ViewHolder> {
    ...
    public TypeTextAdapter(onToolSelecteds onItemSelected) {
        ...
        mToolList.add(new ToolModels("format\nLeft", R.drawable.baseline_format_align_left_24, ToolTypesForTypeTextAdaptor.formatLeft));
        ...
        mToolList.add(new ToolModels("Under\nline", R.drawable.baseline_format_underlined_24, ToolTypesForTypeTextAdaptor.FormatUnderlined));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setBackgroundColor(ContextCompat.getColor(holder.itemView.getContext(), R.color.medium_green));
    }
    @Override
