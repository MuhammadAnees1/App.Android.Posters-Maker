...
public class HomeFragment1 extends Fragment implements EditTextAdapter.OnItemSelected, TypeTextAdapter.onToolSelecteds,HueAdapter.OnHueItemClickListener {
    ...
    static LinearLayout text_buttonsUp,StrokeLayout, hueLayout, imageButtons;
    ...
    Button  editButton,flipButton, copybutton ;
   ...
   final EditTextAdapter editTextAdapter = new EditTextAdapter(this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageButtons = view.findViewById(R.id.Image_buttons);
        ...
        TypeTextLayout.setLayoutManager(new GridLayoutManager(getContext(), 4));
        TypeTextLayout.setAdapter(typeTextAdapter);

        Image_control_opacity.setOnClickListener(v -> {
            setDefaultState();
            imageButtons.setVisibility(View.VISIBLE);
            Image_control_opacity.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_opacity.getContext(), R.color.dark_green));
            Image_control_button.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_button.getContext(), R.color.transparent));
            Image_filter.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_filter.getContext(), R.color.transparent));
        ...
        Image_filter.setOnClickListener(v -> {
            ...
            if(MainActivity.selectedLayer1 != null ){
                ...
                setDefaultState();
                imageButtons.setVisibility(View.VISIBLE);
                Image_control_opacity.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_opacity.getContext(), R.color.transparent));
                Image_control_button.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_button.getContext(), R.color.transparent));
                Image_filter.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_filter.getContext(), R.color.dark_green));
        ...
        Image_control_button.setOnClickListener(v -> {
            if(text_buttonsUp.getVisibility() != View.VISIBLE){
                ...
                imageButtons.setVisibility(View.VISIBLE);
                Image_control_opacity.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_opacity.getContext(), R.color.transparent));
                Image_control_button.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_control_button.getContext(), R.color.dark_green));
                Image_filter.setBackgroundColor(ContextCompat.getColor(HomeFragment1.Image_filter.getContext(), R.color.transparent));
...
//
//
//        final List<Font>[] fontList1 = new List[]{new ArrayList<>()};
//        FontApi.getFontListFromApi(new FontApi.OnFontListReceivedListener() {
//            @Override
//            public void onFontListReceived(List<Font> fontList) {
//        fontList1[0] = fontList;
//            }
//        });
//        Log.d("TAG", "getFontList: "+ fontList1[0].size());
//        return fontList1[0];
//    }
